...
import kr.ac.dankook.CareerApplication.exception.MailException;
...
public class MailService {
    ...
    private static final long AUTH_MAIL_TOKEN_EXPIRE_TIME = 1000 * 60 * 15;
    ...
    public MailResponse createVerifyCodeMailResponse(Member member) {
        ...
        return MailResponse.builder()
                ...
                .title("[Safe-WorkCare] 인증번호 안내 이메일 입니다.")
                .content(content)
                .build();
    }
    ...
    private void saveVerificationCode(Member member, String verificationCode) {
        ...
        String authMailToken = "NaHC-Career"+member.getEmail()+"_"+member.getUserId();
