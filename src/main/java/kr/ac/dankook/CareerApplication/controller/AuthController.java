...
import kr.ac.dankook.CareerApplication.dto.request.*;
import kr.ac.dankook.CareerApplication.dto.response.ApiResponse;
import kr.ac.dankook.CareerApplication.dto.response.AuthMailResponse;
import kr.ac.dankook.CareerApplication.dto.response.MailResponse;
import kr.ac.dankook.CareerApplication.dto.response.TokenResponse;
...
import kr.ac.dankook.CareerApplication.service.MailService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<List<String>>> findId(
            @RequestBody @Valid FindIdRequest findIdRequest, BindingResult bindingResult){
